...
import com.xiaoyuan54.child.edu.app.bean.BarCode;
import com.xiaoyuan54.child.edu.app.bean.ResultBean;
import com.xiaoyuan54.child.edu.app.bean.SingInResult;
...
public final class CaptureActivity extends BaseActivity implements
    ...
    private void handleScanLogin(final String url) {
        HttpClientApi.scanQrCodeLogin(url, new AsyncHttpResponseHandler() {
    ...
    private void handleSignIn(BarCode barCode) {
        ...
        HttpClientApi.singnIn(barCode.getUrl(), handler);
    }
