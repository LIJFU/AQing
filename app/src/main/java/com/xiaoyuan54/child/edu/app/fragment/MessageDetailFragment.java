...
import com.xiaoyuan54.child.edu.app.adapter.MessageDetailAdapter;
...
import com.xiaoyuan54.child.edu.app.bean.MessageDetail;
import com.xiaoyuan54.child.edu.app.bean.MessageDetailList;
...
public class MessageDetailFragment extends BaseListFragment<MessageDetail> implements
    ...
    private void handleShowDate(List<MessageDetail> list) {
        ...
        for (int i = list.size() - 1; i >= 0; i--) {
            msg = list.get(i);
            Date date = com.xiaoyuan54.child.edu.app.util.StringUtils.toDate(msg.getPubDate());
    ...
    protected void sendRequestData() {
        HttpClientApi.getChatMessageList(mFid, mCurrentPage, mHandler);
    }
    ...
    private void handleDeleteMessage(final MessageDetail message) {
        DialogHelp.getConfirmDialog(getActivity(), "是否删除该私信?", new DialogInterface
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                HttpClientApi.deleteComment(mFid,
    ...
    private void sendMessage(MessageDetail msg) {
        ...
        Date date = new Date();
        msg.setPubDate(com.xiaoyuan54.child.edu.app.util.StringUtils.getDateString(date));
        ...
        HttpClientApi.publicMessage(msg.getAuthorId(), mFid, msg.getContent(), new
