...
import com.xiaoyuan54.child.edu.app.improve.detail.fragments.NewsDetailFragment;
...
public class NewsDetailActivity extends DetailActivity<NewsDetail, NewsDetailContract.View> implements NewsDetailContract.Operator {
    ...
    @Override
    void requestData() {
        HttpClientApi.getNewsDetail(getDataId(), HttpClientApi.CATALOG_NEWS_DETAIL, getRequestHandler());
    }
    ...
    public void toSendComment(long id, long commentId, long commentAuthorId, String comment) {
        ...
        HttpClientApi.pubNewsComment(id, commentId, commentAuthorId, comment, new TextHttpResponseHandler() {
