package com.xiaoyuan54.child.edu.app.api;
...
public class ApiHttpClient {
    ...
    public final static String HOST = "192.168.2.236";
   // public static String API_URL = "http://192.168.1.102:8080/childEduServer/%s";
    public static String API_URL = "http://192.168.2.236:8080/childEduServer/%s";
    ...
    public static void takeWithCookie()
    {
        ...
        if(null!=cookies)
        {
            ...
            for(Cookie cookie : cookies)
            {
                ...
                Log.e("http","--------------->>cookie "+cookie.getName()+":"+cookie.getValue());
            }
            setCookie(cookieStr.toString());
        }
