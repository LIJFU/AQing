...
import com.xiaoyuan54.child.edu.app.improve.detail.contract.BlogDetailContract;
import com.xiaoyuan54.child.edu.app.improve.detail.fragments.BlogDetailFragment;
import com.xiaoyuan54.child.edu.app.improve.detail.fragments.DetailFragment;
import com.xiaoyuan54.child.edu.app.improve.bean.BlogDetail;
...
public class BlogDetailActivity extends DetailActivity<BlogDetail, BlogDetailContract.View> implements BlogDetailContract.Operator {
    ...
    @Override
    void requestData() {
        HttpClientApi.getBlogDetail(getDataId(), getRequestHandler());
    }
    ...
    public void toFavorite() {
        ...
        HttpClientApi.getFavReverse(getDataId(), 3, new TextHttpResponseHandler() {
            @Override
    ...
    public void toFollow() {
        ...
        showWaitDialog(R.string.progress_submit);
        final BlogDetail blogDetail = getData();
        HttpClientApi.addUserRelationReverse(blogDetail.getAuthorId(), new TextHttpResponseHandler() {
            @Override
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
    ...
    public void toSendComment(long id, long commentId, long commentAuthorId, String comment) {
        ...
        HttpClientApi.pubBlogComment(id, commentId, commentAuthorId, comment, new TextHttpResponseHandler() {
