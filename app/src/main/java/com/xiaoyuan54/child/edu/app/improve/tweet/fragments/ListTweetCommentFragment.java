...
public class ListTweetCommentFragment extends BaseRecyclerViewFragment<TweetComment>
    ...
    protected Type getType() {
        return new TypeToken<ResultBean<ProPageBean<TweetComment>>>() {
        }.getType();
    }
    ...
    public void onLoadMore() {
        HttpClientApi.getTweetCommentList(
    ...
    public void requestData() {
        HttpClientApi.getTweetCommentList(mOperator.getTweetDetail().getId(), null, mHandler);
    }
    ...
    private void handleDeleteComment(TweetComment comment) {
        ...
        HttpClientApi.deleteTweetComment(mOperator.getTweetDetail().getId(), comment.getId(), new TextHttpResponseHandler() {
            @Override
