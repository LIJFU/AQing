...
public class SongCommonAdapter extends BaseRecyclerAdapter<Album>{
    ...
    public SongCommonAdapter(Context context)
    {
    ...
    @Override
    protected void onBindDefaultViewHolder(RecyclerView.ViewHolder h, Album item, int position)
    {
