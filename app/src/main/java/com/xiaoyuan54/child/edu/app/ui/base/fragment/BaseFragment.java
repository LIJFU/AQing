package com.xiaoyuan54.child.edu.app.ui.base.fragment;
...
public abstract class BaseFragment extends Fragment {
    ...
    private boolean can_back_press = true;
    ...
    public void onDestroy() {
        ...
        if (manager != null)
            manager.onDestroy();
        mBundle = null;
        Log.e("fragment"," fragment destroy-------------->>"+this.getTag());
    }
    ...
    {
        this.can_back_press =canBackPress;
    }

    public boolean getCanBackPress()
    {
       return this.can_back_press;
    }
