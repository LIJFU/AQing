...
import com.xiaoyuan54.child.edu.app.improve.tweet.adapter.TweetCommentAdapter;
import com.xiaoyuan54.child.edu.app.improve.widget.OWebView;
...
public class QuestionAnswerDetailActivity extends BaseBackActivity {
    ...
    protected void initWidget() {
        ...
        mDelegation.setAdapter(new KeyboardInputDelegation.KeyboardInputAdapter() {
            ...
            public void onSubmit(TextView v, String content) {
                ...
                HttpClientApi.publishComment(sid, -1, comment.getId(), comment.getAuthorId(), 2, content, onSendCommentHandler);
            }
    ...
    protected void initData() {
        ...
        HttpClientApi.getComment(comment.getId(), comment.getAuthorId(), 2, new TextHttpResponseHandler() {
            @Override
        ...
        if (mVoteDialogView == null) {
            ...
            View.OnClickListener listener = new View.OnClickListener() {
                ...
                public void onClick(final View v) {
                    ...
                    HttpClientApi.questionVote(sid, comment.getId(), opt, new TextHttpResponseHandler() {
                        @Override
                        public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
