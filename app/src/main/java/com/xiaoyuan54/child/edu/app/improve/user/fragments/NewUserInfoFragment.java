...
import com.xiaoyuan54.child.edu.app.improve.user.activities.UserFansActivity;
import com.xiaoyuan54.child.edu.app.improve.user.activities.UserFollowsActivity;
import com.xiaoyuan54.child.edu.app.improve.user.activities.UserMessageActivity;
import com.xiaoyuan54.child.edu.app.improve.user.activities.UserTweetActivity;
import com.xiaoyuan54.child.edu.app.improve.widget.SolarSystemView;
import com.xiaoyuan54.child.edu.app.improve.widget.TitleBar;
import com.xiaoyuan54.child.edu.app.interf.OnTabReselectListener;

import com.xiaoyuan54.child.edu.app.bean.User;
import com.xiaoyuan54.child.edu.app.ui.MyQRCodeDialog;
...
//        updateSolar(mPx, mPy);
    ...
    private void sendRequestData() {
        HttpClientApi.getUserInfo(textHandler);
    }
    ...
    private void uploadNewPhoto() {
        ...
        if (mPortraitFile != null) {
            mIsUploadIcon = true;
            HttpClientApi.updateUserIcon(mPortraitFile, textHandler);
        }
    }
