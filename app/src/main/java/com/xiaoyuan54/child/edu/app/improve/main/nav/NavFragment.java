...
import com.xiaoyuan54.child.edu.app.improve.main.tabs.ExploreFragment;
...
import com.xiaoyuan54.child.edu.app.improve.tweet.activities.TweetPublishActivity;
...
public class NavFragment extends BaseFragment implements View.OnClickListener, NoticeManager.NoticeNotify {
    ...
    protected void initWidget(View root) {
        ...
        mNavNews.init(R.drawable.tab_icon_tweet,
                R.string.main_tab_name_music,
                MusicMainTabFragment.class);

        mNavTweet.init(R.drawable.tab_icon_tweet,
                R.string.main_tab_name_story,
                FableViewPagerFragmentOld.class);

        mNavExplore.init(R.drawable.tab_icon_tweet,
                R.string.main_tab_name_game,
                ExploreFragment.class);

/*        mNavMe.init(R.drawable.tab_icon_tweet,
                R.string.main_tab_name_my,
                MineMainFragment.class);*/
