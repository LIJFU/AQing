...
import com.xiaoyuan54.child.edu.app.adapter.ActiveAdapter;
...
import com.xiaoyuan54.child.edu.app.bean.UserInformation;
...
public class UserCenterFragment extends BaseFragment implements
    ...
    private void sendGetUserInfomation() {
        HttpClientApi.getUserInformation(mUid, mHisUid, mHisName, mActivePage,
                mActiveHandler);
    }
    ...
    private void sendUpdateRelcationRequest(int ra) {
        HttpClientApi.updateRelation(mUid, mHisUid, ra,
