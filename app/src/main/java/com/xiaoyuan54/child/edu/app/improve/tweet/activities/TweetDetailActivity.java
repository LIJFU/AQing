package com.xiaoyuan54.child.edu.app.improve.tweet.activities;
...
import com.xiaoyuan54.child.edu.app.improve.widget.TweetPicturesLayout;
...
import com.xiaoyuan54.child.edu.app.viewpagerfragment.TweetDetailViewPagerFragment;
import com.xiaoyuan54.child.edu.app.widget.CircleImageView;
...
public class TweetDetailActivity extends BaseBackActivity implements TweetDetailContract.Operator {
    ...
    protected void initData() {
        ...
        HttpClientApi.getTweetDetail(tweet.getId(), new TextHttpResponseHandler() {
            @Override
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
    ...
    protected void initWidget() {
        ...
        mDelegation.setAdapter(new KeyboardInputDelegation.KeyboardInputAdapter() {
            ...
            public void onSubmit(TextView v, String content) {
                ...
                dialog.show();
                HttpClientApi.pubTweetComment(tweet.getId(), content, 0, publishCommentHandler);
            }
    ...
    void onClickThumbUp() {
        ...
        this.dialog.show();
        HttpClientApi.reverseTweetLike(tweet.getId(), publishAdmireHandler);
    }
