...
import com.xiaoyuan54.child.edu.app.bean.Active.ObjectReply;
import com.xiaoyuan54.child.edu.app.emoji.InputHelper;
import com.xiaoyuan54.child.edu.app.ui.AppPhotosActivity;
import com.xiaoyuan54.child.edu.app.util.BitmapHelper;
    ...
    private void setTweetImage(final ViewGroup parent, final ViewHolder vh,
        ...
        vh.pic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AppPhotosActivity.showImagePreview(parent.getContext(), getOriginalUrl(item.getTweetimage()));
            }
        });
    }
