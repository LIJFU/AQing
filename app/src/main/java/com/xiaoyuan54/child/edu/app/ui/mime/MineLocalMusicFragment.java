 ...
 */
public class MineLocalMusicFragment extends BaseFragment
{
   ...
   @Bind(R.id.listView) ListView listView;
    ...
    public static MineLocalMusicFragment newInstance()
    {
        Bundle args = new Bundle();
        MineLocalMusicFragment fragment = new MineLocalMusicFragment();
