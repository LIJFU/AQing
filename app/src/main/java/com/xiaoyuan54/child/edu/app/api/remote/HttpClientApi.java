package com.xiaoyuan54.child.edu.app.api.remote;
...
public class HttpClientApi {
    ...
    public static void getMobileCode(String mobile,TextHttpResponseHandler handler) {
        String requestUrl = "user/login/mobilecode/"+mobile;
        ApiHttpClient.getHttpClient().setTimeout(LoginActivity.millisInFuture);
        ApiHttpClient.get(requestUrl,handler);
    }

    //user/login/auto?mobile=15815810700&token=d2175cb26a1c4bf99e4209f5070d669a
    public static void autoLogin(String mobile,String token,AsyncHttpResponseHandler handler){
        RequestParams params =new RequestParams();
        params.put("mobile",mobile);
        params.put("token",token);
        ApiHttpClient.get("user/login/auto",params,handler);
    }

    public static void userLogin(String mobile,String mobileCode,AsyncHttpResponseHandler handler){
        RequestParams params =new RequestParams();
        params.put("mobile",mobile);
        params.put("mobileCode",mobileCode);
        ApiHttpClient.get("user/login/mobile",params,handler);
     ...
     * 请求音乐列表
     */
    public static void getMusicList(int catalog, AsyncHttpResponseHandler handler) {
        if (catalog <= 0)
            catalog = 1;
        RequestParams params = new RequestParams();
        params.put("catalog", catalog);

        ApiHttpClient.get("play/album/songs/1", params, handler);
    }

    /**
     * 请求音乐专辑列表
     */
    public static void getAlbumList(int catalog,int pageNumber,AsyncHttpResponseHandler handler)
    {
        RequestParams params = new RequestParams();
        params.put("pageNum",pageNumber);
        if(catalog>0)
         params.put("catalog", catalog);
        ApiHttpClient.get("play/album/list", params, handler);
    }
     ...
     * 请求音乐专辑列表
     */
    public static void getAlbumSongList(int albumId,AsyncHttpResponseHandler handler)
    {
        RequestParams params = new RequestParams();
        ApiHttpClient.get("play/album/songs/"+albumId, params, handler);
    }

    /**
     * 请求故事列表
     */
    public static void getStoryList(int catalog,int pageNumber,AsyncHttpResponseHandler handler)
    {
        RequestParams params = new RequestParams();
        params.put("pageNum",pageNumber);
        if(catalog>0)
            params.put("catalog", catalog);
        ApiHttpClient.get("play/story/list", params, handler);
    }
    ...
    {
        ApiHttpClient.get("version/info/1001/apk", handler);
    }


    public static void uploadErrorMsg()
    {
