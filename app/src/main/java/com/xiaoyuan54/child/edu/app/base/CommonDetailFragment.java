package com.xiaoyuan54.child.edu.app.base;
...
import com.xiaoyuan54.child.edu.app.ui.ReportDialog;
...
import com.xiaoyuan54.child.edu.app.util.FontSizeUtils;
...
public abstract class CommonDetailFragment<T extends Serializable> extends BaseFragment implements OnSendClickListener {
    ...
    public void handleFavoriteOrNot() {
        ...
        if (isFavorited) {
            HttpClientApi.delFavorite(uid, mId,
                    getFavoriteTargetType(), mFavoriteHandler);
        } else {
            HttpClientApi.addFavorite(uid, mId,
                    getFavoriteTargetType(), mFavoriteHandler);
        }
    }
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface d, int which) {
                        ...
                        if ((report = dialog.getReport()) != null) {
                            ...
                            HttpClientApi.report(report, mReportHandler);
                        }
                        d.dismiss();
                    }
                });
    ...
    public void onClickSendButton(Editable str) {
        ...
        HttpClientApi.publicComment(getCommentType(), mId, AppContext
