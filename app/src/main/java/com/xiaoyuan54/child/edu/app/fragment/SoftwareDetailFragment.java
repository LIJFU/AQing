...
import com.xiaoyuan54.child.edu.app.bean.Software;
import com.xiaoyuan54.child.edu.app.bean.SoftwareDetail;
...
public class SoftwareDetailFragment extends CommonDetailFragment<Software> {
    ...
    protected void sendRequestDataForNet() {
        // 通过id来获取软件详情
        if (mId > 0) {
            HttpClientApi.getSoftwareDetail(mId, mDetailHeandler);
            return;
        }
        ...
        HttpClientApi.getSoftwareDetail(mIden, mDetailHeandler);
    }
    ...
    public void onClickSendButton(Editable str) {
        ...
        HttpClientApi.pubSoftWareTweet(tweet, mDetail.getId(), mCommentHandler);
    }
