...
import com.xiaoyuan54.child.edu.app.improve.bean.QuestionDetail;
import com.xiaoyuan54.child.edu.app.improve.bean.base.ResultBean;
import com.xiaoyuan54.child.edu.app.improve.detail.contract.QuestionDetailContract;
import com.xiaoyuan54.child.edu.app.improve.detail.fragments.DetailFragment;
import com.xiaoyuan54.child.edu.app.improve.bean.simple.CommentEX;
import com.xiaoyuan54.child.edu.app.improve.detail.fragments.QuestionDetailFragment;
...
public class QuestionDetailActivity extends DetailActivity<QuestionDetail, QuestionDetailContract.View> implements QuestionDetailContract.Operator {
    ...
    @Override
    void requestData() {
        HttpClientApi.getQuestionDetail(getDataId(), getRequestHandler());
    }
    ...
    public void toFavorite() {
        ...
        HttpClientApi.getFavReverse(getDataId(), 2, new TextHttpResponseHandler() {
            @Override
    ...
    public void toSendComment(long id, long commentId, long commentAuthorId, String comment) {
        ...
        HttpClientApi.pubQuestionComment(id, commentId, commentAuthorId, comment, new TextHttpResponseHandler() {
