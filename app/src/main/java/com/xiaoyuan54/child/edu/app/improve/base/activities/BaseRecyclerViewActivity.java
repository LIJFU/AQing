package com.xiaoyuan54.child.edu.app.improve.base.activities;
...
public abstract class BaseRecyclerViewActivity<T> extends BaseBackActivity implements
    ...
    protected void initData() {
        ...
        mHandler = new TextHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, String responseString) {
                try {
                    ResultBean<ProPageBean<T>> resultBean = AppContext.createGson().fromJson(responseString, getType());
    ...
    protected void setListData(ResultBean<ProPageBean<T>> resultBean)
    {
        if (mIsRefresh)
        {
