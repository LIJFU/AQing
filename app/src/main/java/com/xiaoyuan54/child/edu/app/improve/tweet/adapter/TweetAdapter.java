package com.xiaoyuan54.child.edu.app.improve.tweet.adapter;
...
import com.xiaoyuan54.child.edu.app.improve.bean.simple.TweetLikeReverse;
    ...
    private void initListener() {
        listener = new OnTweetLikeClickListener() {
            ...
            public void onClick(View v, int position) {
                HttpClientApi.reverseTweetLike(getItem(position).getId(), new TweetLikedHandler(position));
            }
        };
    }
