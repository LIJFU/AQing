...
import com.xiaoyuan54.child.edu.app.improve.bean.simple.UserRelation;
import com.xiaoyuan54.child.edu.app.improve.user.fragments.UserActiveFragment;
import com.xiaoyuan54.child.edu.app.improve.user.fragments.UserQuestionFragment;
import com.xiaoyuan54.child.edu.app.improve.user.fragments.UserTweetFragment;
import com.xiaoyuan54.child.edu.app.improve.widget.SolarSystemView;
import com.xiaoyuan54.child.edu.app.improve.bean.User;
...
public class OtherUserHomeActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initData() {
        super.initData();
        HttpClientApi.getUserInfo(user.getId(), user.getName(), user.getSuffix(), new TextHttpResponseHandler() {
            @Override
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        com.xiaoyuan54.child.edu.app.bean.User mLoginUser = AppContext.getInstance().getLoginUser();
            ...
            case R.id.menu_follow:
                ...
                DialogHelp.getConfirmDialog(this, mDialogTitle, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        HttpClientApi.addUserRelationReverse(user.getId(), new TextHttpResponseHandler() {
                            @Override
                            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
