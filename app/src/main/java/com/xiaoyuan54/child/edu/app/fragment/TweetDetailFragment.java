...
import com.xiaoyuan54.child.edu.app.adapter.CommentAdapter;
...
import com.xiaoyuan54.child.edu.app.base.BeseHaveHeaderListFragment;
...
import com.xiaoyuan54.child.edu.app.bean.TweetDetail;
import com.xiaoyuan54.child.edu.app.cache.CacheManager;
import com.xiaoyuan54.child.edu.app.emoji.OnSendClickListener;
...
import com.xiaoyuan54.child.edu.app.util.KJAnimations;
...
import com.xiaoyuan54.child.edu.app.util.TypefaceUtils;
...
import com.xiaoyuan54.child.edu.app.widget.RecordButtonUtil;
import com.xiaoyuan54.child.edu.app.widget.RecordButtonUtil.OnPlayListener;
...
public class TweetDetailFragment extends
    ...
    protected void sendRequestData() {
        HttpClientApi.getCommentList(mTweetId, CommentList.CATALOG_TWEET,
    ...
    private void handleDeleteComment(Comment comment) {
        ...
        HttpClientApi.deleteComment(mTweetId, CommentList.CATALOG_TWEET,
    ...
    protected void requestDetailData(boolean isRefresh) {
        ...
        if (TDevice.hasInternet()
            ...
            HttpClientApi.getTweetDetail(mTweetId, mDetailHandler);
        } else {
    ...
    private void likeOption() {
        ...
        if (AppContext.getInstance().isLogin()) {
            if (mTweet.getIsLike() == 1) {
                ...
                HttpClientApi.pubUnLikeTweet(mTweetId, mTweet.getAuthorid(),
                        handler);
            } else {
        ...
        try {
            if (outAty.emojiFragment.getEditText().getTag() != null) {
                Comment comment = (Comment) outAty.emojiFragment.getEditText()
                        .getTag();
                HttpClientApi.replyComment(mTweetId, CommentList.CATALOG_TWEET,
                        comment.getId(), comment.getAuthorId(), AppContext
                                .getInstance().getLoginUid(), str.toString(),
                        mCommentHandler);
            } else {
                HttpClientApi.publicComment(CommentList.CATALOG_TWEET, mTweetId,
